                            ...
                            <div class="progress">
                                <div class="progress-item">
                                    ...
                                    <div class="progress-box">
                                        <el-progress :percentage=parseInt(state.resource.cpu)
                                ...
                                <div class="progress-item">
                                    <span>内存使用率</span>
                                    <div class="progress-box">
                                        <el-progress :percentage=parseInt(state.resource.memory)
                                                     color="#43bdf0"></el-progress>
                                    </div>
                                </div>
                                <div class="progress-item">
                                    <span>硬盘使用率</span>
                                    <div class="progress-box">
                                        <el-progress :percentage=parseInt(state.resource.disk)
                                                     color="#43bdf0"></el-progress>
                                    </div>
                                </div>
                                <div class="progress-item">
                                    <span>网络使用率</span>
                                    <div class="progress-box">
                                        <el-progress :percentage=parseInt(state.resource.network)
                                                     color="#43bdf0"></el-progress>
                                    </div>
                                </div>
                            </div>
...
<script setup lang="ts" name="home">
    ...
    const Statistics = defineAsyncComponent(() => import('/@/views/home/fedetail.vue'));
