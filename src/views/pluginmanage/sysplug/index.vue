<template>
	<div class="filtering layout-pd" style="flex-grow: 1; display: flex">
		<el-card
			shadow="hover"
		...
		>
			...
			<div class="flex-warp mt15 mb15" v-if="state.tableData.data.length > 0">
				<el-row :gutter="15">
					<el-col :xs="24" :sm="12" :md="8" :lg="6" class="mb15" :xl="4" v-for="(v, k) in state.tableData.data" :key="k">
						<div class="cardClass">
							<div class="list-card-item_detail bg-bg_color">
								<el-row justify="space-between">
									...
									<div class="list-card-item_detail--operation" v-if="false">
										<el-tag :color="v.Status == 'true' ? '#00a870' : '#eee'" effect="dark" class="mx-1 list-card-item_detail--operation--tag">
										...
										<el-dropdown trigger="click">
											...
											<template #dropdown>
												<el-dropdown-menu>
													<el-dropdown-item @click="onOpenEdit('edit', v)"> 管理 </el-dropdown-item>
													<el-dropdown-item @click="onRowDel(v)"> 删除 </el-dropdown-item>
												</el-dropdown-menu>
											</template>
										</el-dropdown>
									</div>
								...
								<div class="buttons">
									<el-button type="text" size="small" @click.stop="onOpenEdit('edit', v)">
										<el-icon>
											<ele-Edit />
										</el-icon>
										编辑
									</el-button>
									<el-button type="danger" link size="small" @click.stop="onRowDel(v)">
										<el-icon>
											<ele-Delete />
										</el-icon>
										删除
