                ...
                <div class="workflow-content">
                    ...
                    <div id="workflow-right" class="workflow-right" ref="workflowRightRef">
                        ...
                        <div style="width: 100%">
                            ...
                            <div class="flex-warp-item Source">
                                <div class="flex-warp-item-box">
                                    <div class="item-img">
                                        <img :src="gateimg"/>
                                    </div>
                        ...
                        >
                            ...
                            <div :class="`flex-warp-item2 Target ${v.ID}`">
                                <div class="flex-warp-item-box ">
                                    <div class="item-img">
...
<script setup lang="ts" name="pagesWorkflow">
        ...
        (<any>jsPlumb).ready(() => {
            ...
            state.jsPlumb.bind('beforeDrop', (conn: any) => {
                ...
                if (existingConnections.length > 0) {
                    ElMessage.warning('该流程已分发，不可重复添加');
                    return false;
                } else {
                    return true;
                }
    ...
    const initNodes = () => {
        ...
        const SourceElList = document.querySelectorAll('.Source')
    ...
    const initConn = () => {
        ...
        for (let k of list) {
            ...
            let label = getFlowName(k.FlowID);
    ...
    onMounted(async () => {
        ...
        state.gateway.ID = state.tableGateway.data[0].ID;
        state.gateway.Name = state.tableGateway.data[0].Name
        state.gateway.IP = state.tableGateway.data[0].IP;
        state.gateway.Describes = state.tableGateway.data[0].Describes;
