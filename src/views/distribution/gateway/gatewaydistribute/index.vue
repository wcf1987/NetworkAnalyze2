            ...
            <div class="workflow">
                ...
                <div class="workflow-content">
                    ...
                    <div id="workflow-right" class="workflow-right" ref="workflowRightRef">
                        ...
                        <div
                                v-for="v in state.tableDataFlow.data"
                                :key="v.ID"
...
<script setup lang="ts" name="pagesWorkflow">
    ...
    const getTableDataGatewayDistribute = async () => {
        ...
        await gatewayApi().searchGatewayDistribute(
            {
                uid: 1,
    ...
    const initLeaf = (row, type) => {
        ...
        if (type == 'Source') {
            ...
            ins.setId(elem, "source_" + state.gateway.ID);
    ...
    const initConn = () => {
        ...
        state.jsPlumb.deleteEveryConnection();
            let sourceid = "source_" + state.gateway.ID;
        for (let k of list){
