    ...
    <div class="system-user-container layout-padding">
        <el-card shadow="hover" class="layout-padding-auto">
            <div class="system-user-search mb15">
                <el-input  clearable size="default" placeholder="请输入消息体名称" style="max-width: 180px"
            ...
            <el-table @sort-change="sort_change" :cell-style="{'padding': '2px 2px 0 0px' , textAlign: 'center'}" :header-cell-style="{ textAlign: 'center' }"   :data="state.tableData.data" v-loading="state.tableData.loading" style="width: 100%" @selection-change="handleSelectionChange">
...
<script setup lang="ts" name="systemUser">
  ...
  messbodyApi().searchMessBody(
        ...
        //const data = [];
        messbodyApi().getMessBodySearchListSize(
            {
                uid: 1,
                name: state.tableData.searchStr,
            })
    ...
    const onDeleteIDS = (type: string) => {
        ElMessageBox.confirm(`此操作将批量删除网口：“${state.tableData.ids.length}”条，是否继续?`, '提示', {
            ...
            .then(() => {
                messbodyApi().delIDS(                                          state.tableData.ids
