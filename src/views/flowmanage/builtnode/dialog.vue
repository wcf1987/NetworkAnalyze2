                ...
                <el-row :gutter="35">
                    ...
                    <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
                        <el-form-item label="类型" prop="Type">
                            <el-select v-model="state.ruleForm.Type" placeholder="请选择" clearable class="w100" :disabled="true">
                                <el-option label="内置封装节点" value="内置封装节点"></el-option>
                                <el-option label="内置转换节点" value="内置转换节点"></el-option>
